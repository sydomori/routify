...
const selectedIcon = new L.Icon({ /* Leaflet's class for creating custom marker icons */
    iconUrl: 'https://unpkg.com/leaflet@1.9.4/dist/images/marker-icon.png', /* path to the icon image */
    shadowUrl: 'https://unpkg.com/leaflet@1.9.4/dist/images/marker-shadow.png', /* path to the shadow image */
